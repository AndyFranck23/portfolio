...
export const NavComponent = () => {
    ...
    return (
        <div className="sm:text-md bg-[url('./src/assets/background2.jpg')] bg-auto bg-cover bg-contain">
...
export const HelloWorld = ({ click }) => {
    ...
    return (
        <div className="flex justify-center items-center text-black h-screen w-screen bg-[url('./src/assets/background2.jpg')] bg-auto bg-cover bg-contain">
            <div className="">
